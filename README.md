...
This is a collection of python scripts I made to make my life easier when dealing with ANSYS Workbench Batch mode. It requres no additional python packeges whatsoever. Right now there are 4 modules:
